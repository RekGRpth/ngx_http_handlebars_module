...
--- config
    location /handlebars {
        ...
        handlebars_template '12345{{! Comment Block! }}67890';
...
--- config
    location /handlebars {
        default_type application/json;
        handlebars_template "  {{! I'm Still Standalone }}\n!";
        handlebars_content text/html;
        return 200 '{}';
    }
--- request
