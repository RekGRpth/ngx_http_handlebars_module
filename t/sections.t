...
--- config
    location /test {
        default_type application/json;
        handlebars_template "\"{{#null}}This should not be rendered.{{/null}}\"";
        handlebars_content text/html;
        return 200 '{
        "null": null
      }';
...
--- config
    location /test {
        default_type application/json;
        handlebars_template "\"{{#sec}}{{a}}, {{b}}, {{c.d}}{{/sec}}\"";
        handlebars_content text/html;
        return 200 '{
        "a": "foo",
        "b": "wrong",
...
--- config
    location /test {
        default_type application/json;
        handlebars_template "\"{{#foo}}{{.}} is {{foo}}{{/foo}}\"";
        handlebars_content text/html;
        return 200 '{
        "foo": "bar"
      }';
...
--- config
    location /test {
        default_type application/json;
        handlebars_template "{{#tops}}{{#middles}}{{tname.lower}}{{mname}}.{{#bottoms}}{{tname.upper}}{{mname}}{{bname}}.{{/bottoms}}{{/middles}}{{/tops}}";
        handlebars_content text/html;
        return 200 '{
        "tops": [
          {
...
--- config
    location /test {
        default_type application/json;
        handlebars_template "\"{{#list}}{{item}}{{/list}}\"";
        handlebars_content text/html;
        return 200 '{
        "list": [
          {
...
--- config
    location /test {
        default_type application/json;
        handlebars_template "[{{#missing}}Found key 'missing'!{{/missing}}]";
        handlebars_content text/html;
        return 200 '{
      }';
    }
...
--- config
    location /test {
        default_type application/json;
        handlebars_template "\"{{#a.b.c}}Here{{/a.b.c}}\" == \"Here\"";
        handlebars_content text/html;
        return 200 '{
        "a": {
          "b": {
...
--- config
    location /test {
        default_type application/json;
        handlebars_template "\"{{#a.b.c}}Here{{/a.b.c}}\" == \"\"";
        handlebars_content text/html;
        return 200 '{
        "a": {
          "b": {
...
--- config
    location /test {
        default_type application/json;
        handlebars_template " {{#boolean}}YES{{/boolean}}\n {{#boolean}}GOOD{{/boolean}}\n";
        handlebars_content text/html;
        return 200 '{
        "boolean": true
      }';
